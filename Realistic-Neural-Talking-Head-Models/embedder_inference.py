...
path_to_e_hat_video = 'examples/result/e_hat_video.tar'
path_to_e_hat_images = 'examples/result/e_hat_images.tar'
path_to_chkpt = 'experiment/model_weights.tar'
# path_to_video = 'examples/fine_tuning/test_video.mp4'
path_to_video = '/home/cxu-serve/p1/common/voxceleb2/unzip/test_video/id00017/01dfn2spqyE/00001_aligned.mp4'
