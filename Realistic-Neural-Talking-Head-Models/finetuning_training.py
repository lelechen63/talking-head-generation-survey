...
path_to_embedding = 'examples/gen_result/e_hat_video.tar'
path_to_chkpt = 'checkpoints/model_weights.tar'
path_to_save = 'checkpoints/finetuned_model.tar'
# path_to_video = 'examples/result/self/gt/gt.mp4'
# path_to_video = 'examples/fine_tuning/test_video.mp4'
path_to_video = '/home/cxu-serve/p1/common/voxceleb2/unzip/test_video/id00017/utfjXffHDgg/00198.mp4'
...
for epoch in range(num_epochs):
    for i_batch, (x, g_y) in enumerate(dataLoader):
        ...
        if epoch % 10 == 0:
            ...
            plt.imshow(out)
            # plt.show()
            plt.savefig('examples/result/generate.png')
            plt.close()
            ...
            plt.imshow(out)
            # plt.show()
            plt.savefig('examples/result/gt.png')
            plt.close()
            ...
            plt.imshow(out)
            # plt.show()
            plt.savefig('examples/result/landmark.png')
            plt.close()
...
# plt.show()
plt.savefig('examples/result/loss.png')
